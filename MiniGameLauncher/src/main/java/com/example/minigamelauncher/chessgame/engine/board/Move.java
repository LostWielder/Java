...
import com.example.minigamelauncher.chessgame.engine.piece.Pawn;
...
import static com.example.minigamelauncher.chessgame.engine.board.Board.Builder;
...
public abstract class Move {
    ...
    public static class MajorAttackMove extends AttackMove {
        public MajorAttackMove(final Board board, final Piece pieceMoved, final int destinationCoordinate, Piece pieceAttacked) {
        ...
        public String toString() {
            return movedPiece.getPieceType() + Utils.getPositionAtCoordinate(this.destinationCoordinate);
        }
    ...
    public static final class MajorMove extends Move {
        ...
        @Override
        public String toString() {
            return movedPiece.getPieceType().toString() + Utils.getPositionAtCoordinate(this.destinationCoordinate);
        }
    ...
    public static final class PawnMove extends Move {
        ...
        @Override
        public String toString() {
            return Utils.getPositionAtCoordinate(this.destinationCoordinate);
        }
    }
    ...
    public static class PawnAttackMove extends AttackMove {
        ...
        @Override
        public String toString() {
            return Utils.getPositionAtCoordinate(this.movedPiece.getPiecePosition()).substring(0,1) + "x" +
                    Utils.getPositionAtCoordinate(this.destinationCoordinate);
        }
    }
    ...
    public static final class NullMove extends Move {
        ...
        @Override
        public Board execute() {
            throw new RuntimeException("Cannot not execute the null move!");
        }
