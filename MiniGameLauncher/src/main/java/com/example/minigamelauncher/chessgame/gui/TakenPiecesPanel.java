...
public class TakenPiecesPanel extends JPanel {
    ...
    private static final Color PANEL_COLOR = Color.pink;
    ...
    public void redo(final Table.MoveLog moveLog) {
        ...
        for(final Piece takenPiece : whiteTakenPieces) {
            try {
                final BufferedImage image = ImageIO.read(new File("ChessPieces/" + takenPiece.getPieceAlliance().toString().substring(0,1) + "" + takenPiece.toString()));
