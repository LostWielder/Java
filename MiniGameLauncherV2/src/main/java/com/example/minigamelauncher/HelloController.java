...
public class HelloController extends CheckersApp {
    ...
    Image chessPreview = new Image(new File("src/main/resources/com/example/minigamelauncher/Launcher/Icons/chessPreview.gif").toURI().toString());
...
gamePreview.setImage(titlePreview);
    ...
    public void highlighted(MouseEvent event){
        ...
        switch (((Button)event.getSource()).getId()){
            ...
            case "playTic"->{author.setText("Written by Autumn Day");
                gamePreview.setImage(ticPreview);
            }
            case "playChess"->{author.setText("Written by Arqam Ahmad");
                gamePreview.setImage(chessPreview);
            }
